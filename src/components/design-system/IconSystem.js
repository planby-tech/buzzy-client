...
export const PlusIcon = ({size, color = 'white'}) => {
  return (
    <Svg
      width={`${size}`}
      height={`${size}`}
...
export const MapMarkerIcon = ({size, color = 'white'}) => {
  return (
    <Svg
      width={`${size}`}
      height={`${size}`}
      ...
      xmlns="http://www.w3.org/2000/svg">
      <Path
        d="M10.5001 17.5C10.5001 17.5 5.88727 11.9762 5.39592 11.0946C4.90456 10.2129 4.65341 9.21929 4.66729 8.2118C4.68118 7.20431 4.95961 6.21785 5.47507 5.34989C5.99054 4.48193 6.72521 3.76251 7.60648 3.2627C8.48775 2.76289 9.48514 2.5 10.5001 2.5C11.515 2.5 12.5124 2.76289 13.3937 3.2627C14.275 3.76251 15.0096 4.48193 15.5251 5.34989C16.0406 6.21785 16.319 7.20431 16.3329 8.2118C16.3468 9.21929 16.0956 10.2129 15.6042 11.0946C15.1129 11.9762 10.5001 17.5 10.5001 17.5Z"
        stroke="white"
        strokeWidth="1.66667"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <Path
        d="M10.5 10.8334C11.8807 10.8334 13 9.71409 13 8.33337C13 6.95266 11.8807 5.83337 10.5 5.83337C9.11929 5.83337 8 6.95266 8 8.33337C8 9.71409 9.11929 10.8334 10.5 10.8334Z"
        stroke="white"
        strokeWidth="1.66667"
        strokeLinecap="round"
        strokeLinejoin="round"
